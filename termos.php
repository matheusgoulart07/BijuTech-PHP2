    ...
    <main class="flex-fill">
        <div class="container">
            <div class="content-wrapper">
                <h2 class="page-title">Política de Trocas e Devoluções</h2>
                ...
                <p class="font-weight-bold text-danger">*ATENÇÃO: Para efetuar o processo de troca, é necessário estar logado.</p>

                <h3>Devolução por Arrependimento/Desistência</h3>
                ...
                <ul class="styled-list">
                    <li><i class="fa fa-check-circle"></i>O produto não poderá ter indícios de uso.</li>
                    <li><i class="fa fa-check-circle"></i>O produto deverá ser encaminhado preferencialmente na embalagem original, acompanhado de nota fiscal, etiquetas, tags (etiqueta com código de referência do produto) devidamente fixada no produto e todos os seus acessórios.</li>
                    <li><i class="fa fa-check-circle"></i>Ao efetuar o processo de devolução, o cliente deverá, no verso da nota fiscal a ser devolvida, informar o motivo da recusa/devolução, o nome e o CPF de quem está devolvendo e a data da devolução.</li>
                </ul>
            </div>
        </div>
    </main>
