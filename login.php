...
if ($_POST) {
    ...
    // ✅ Ajuste: agora usa o campo correto id_usuario
    $select = $conn->prepare("SELECT id_usuario, nome, email, senha, admin FROM usuario WHERE email = :usuario");
